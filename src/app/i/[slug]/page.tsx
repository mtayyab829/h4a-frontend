...
export default function ImagePage() {
  ...
  const shareToInstagram = async () => {
    // Instagram doesn't support direct URL sharing, so we copy the link to clipboard
    try {
      await navigator.clipboard.writeText(shareUrl);
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black flex flex-col">
      ...
      {/* Bottom Action Bar */}
      <div className="fixed bottom-0 left-0 right-0 z-50 bg-white backdrop-blur-md border-t border-gray-200">
        <div className="max-w-4xl mx-auto px-4 py-4">
          <div className="flex items-center justify-center gap-3 flex-wrap">
            ...
            <button
              onClick={handleShare}
              className="flex items-center gap-2 px-4 py-2.5 rounded-full bg-black hover:bg-gray-900 text-white transition-all"
            >
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="w-10 h-10 rounded-full bg-black hover:opacity-90 transition-opacity flex items-center justify-center cursor-pointer"
              ...
              <button
                ...
                className="w-10 h-10 rounded-full bg-white hover:opacity-90 transition-opacity flex items-center justify-center cursor-pointer"
                title="Share on LinkedIn"
              >
                <svg className="w-full h-full text-black rounded-full" fill="black" viewBox="0 0 24 24">
